...
rule {
	name        'pserver.name'
	category    'INVALID_VALUE'
	description 'Invalid value - field must not contain .infra.aic.att.net'
	errorText   'Invalid value - field must not contain .infra.aic.att.net'
	severity    'MINOR'
	attributes  'name'
	validate    'name == null || !name.matches(".*[.]infra[.]aic[.]att[.]net.*")'
}
