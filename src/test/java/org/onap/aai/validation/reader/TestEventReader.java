...
public class TestEventReader {
    ...
    public void testEntityLink() throws Exception {
        ...
        assertThat(entity.getEntityLink(), is(
                "cloud-infrastructure/cloud-regions/cloud-region/att-aic/AAIAIC25/tenants/tenant/example-tenant-id-val-88551/vservers/vserver/example-vserver-id-val-34666"));
    }
